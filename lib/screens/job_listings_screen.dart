  ...
  Widget build(BuildContext context) {
    ...
    List<JobListing> jobListings = [
      ...
      JobListing(
        ...
        qualifications:
            'Bachelor\'s degree in Computer Science or related field. Proficiency in HTML, CSS, JavaScript, and other web development languages and frameworks. Experience with front-end and back-end development. Strong problem-solving skills. Excellent communication and teamwork skills.',
        benefits:
      ...
      JobListing(
        ...
        description:
            'Analyze market trends and develop strategies to promote products or services in targeted markets.',
      ...
      JobListing(
        ...
        description:
            'Collect, analyze, and interpret data to provide insights and support strategic decision-making processes.',
        location: 'Kitchener, ON',
        pay: 60000.0,
        responsibilities:
      ...
      JobListing(
        ...
        logo: 'assets/infosys.jpeg',
        description:
            'Manage and maintain databases to ensure data integrity, security, and optimal performance.',
      ...
      JobListing(
        ...
        logo: 'assets/google.jpeg',
        description:
            'Design, implement, and maintain computer networks, ensuring reliability and security.',
        location: 'Guelph, ON',
        pay: 40000.0,
        responsibilities:
      ...
      JobListing(
        ...
        logo: 'assets/reliance.jpeg',
        description:
            'Provide technical support and assistance to users, troubleshooting hardware and software issues.',
      ...
      JobListing(
        ...
        logo: 'assets/microsoft.jpg',
        description:
            'Design, code, and test software applications and systems to meet business requirements.',
        ...
        qualifications:
            'Bachelor\'s degree in Computer Science or related field. Proven experience as a software developer or programmer analyst. Proficiency in programming languages such as Java, C#, Python, etc. Strong problem-solving and analytical skills. Excellent communication and teamwork skills.',
        benefits:
            'Competitive salary and benefits package. Opportunities for career growth and advancement. Training and professional development programs. Health, dental, and vision insurance. Retirement savings plans. Flexible work hours and remote work options. Employee assistance programs. Onsite amenities and wellness programs.',
      ),
      JobListing(
        ...
        logo: 'assets/tata.jpeg',
        description:
            'Develop and maintain mobile and web applications to meet client specifications and business needs.',
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Pay: \$${jobListing.pay.toStringAsFixed(2)}',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.grey[600],
                      ),
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          JobDetailScreen(jobListing: jobListing),
                    ),
                  );
                },
              ),
